...
contextBridge.exposeInMainWorld('cmd', {
  sshConnect: (host: string, username: string, password: string) =>
...
contextBridge.exposeInMainWorld('fs', {
  unpackTarToDest: (buffer: Uint8Array, dest: string) =>
    ipcRenderer.invoke('unpack-tar-buffer', buffer, dest),

  readDirRecursive: (dirPath: string) =>
...
contextBridge.exposeInMainWorld('regex', {
  filterStateFlow: (content: string) =>
    ipcRenderer.invoke('filter-state-flow', content),
});
